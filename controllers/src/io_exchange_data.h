#ifndef OATMEAL_GAZEBO_CONTROLLERS_SRC_IO_EXCHANGE_DATA_H_
#define OATMEAL_GAZEBO_CONTROLLERS_SRC_IO_EXCHANGE_DATA_H_
...
#endif  // OATMEAL_GAZEBO_CONTROLLERS_SRC_IO_EXCHANGE_DATA_H_
